//global variables, can be accessed by all functions
  ...
  //declare a variable named playerName that saves the value the player enters into a prompt
...
//use randomNum to generate attack points value between 1 - 6 and save the value to a variable named playerAttackPoints
...
function monsterAttack(){
  //use randomNum to generate attack points value between 1 - 6 and save the value to a variable named monsterAttackPoints
...
function playRound() {
  //use randomNum to generate an integer between 0 to 2 (0 or 1)
...
function playGame() {
 ...
 let roundNumber = 0
  ...
  //outside of while loop, declare a winner and use alert to show win or lose message 
}
